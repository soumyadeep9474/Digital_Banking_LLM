        ...
        <div className='text-gray-500 w-full'>
            <PageNavbar>
                <PageNavbarLeftContent>
                    ...
                    <div>
                        <h1 className='text-sm font-semibold text-gray-800'>Transaction History</h1>
                        <p className='text-xs font-medium'>Monitor and manage financial transactions&apos;s teams</p>
                    </div>
                </PageNavbarLeftContent>
            ...
            <PageContent>
                ...
                <div className='text-sm md:pb-2 flex items-center justify-between'>
                    <div>
                        <h1 className='text-gray-800 font-medium'>Recent Transactions</h1>
                        <p className='text-xs'>View all processed payments and pending transactions</p>
                    </div>
