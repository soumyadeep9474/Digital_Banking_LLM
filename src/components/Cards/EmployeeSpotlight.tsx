...
import { Edit2, Heart, MagicStar, Medal, Send2 } from 'iconsax-react'
        ...
        <div className='border text-gray-500 w-full p-3 rounded-2xl space-y-4'>
            ...
            <div className='flex items-center justify-between'>
                <div className='flex items-center text-sm gap-2'>
                    <MagicStar size={18} />
                    <p className='text-gray-800 font-medium'>Banking Spotlight</p>
                </div>
            ...
            <div className='flex text-xs font-medium relative bg-gray-100 p-2 rounded-lg py-1'>
                <button onClick={() => setActiveTab('overview')} className={`z-10 w-full px-2 py-1 ${activeTab === 'overview' ? '' : ''}`}>Transactions</button>
                <button onClick={() => setActiveTab('comments')} className={`z-10 w-full px-2 py-1.5 rounded-lg ${activeTab === 'comments' ? '' : ''}`}>Rewards</button>
                <button onClick={() => setActiveTab('rewards')} className={`z-10 w-full px-2 py-1 ${activeTab === 'rewards' ? '' : ''}`}>Offers</button>
                ...
                >
                    <div className='flex items-center gap-2'>
                        ...
                        <div className='font-medium'>
                            ...
                            <p className='text-sm text-gray-700 font-medium'>Deposit Successful! 💰</p>
                        </div>
                    </div>
